...
public class BodyPart : MonoBehaviour
{
    ...
    // Представляет позицию и поворот для отображения фонтана крови, бьющего из основного тела
    public Transform bloodFountainOrigin;
    // Если имеет значение true, после падения из этого объекта должны быть удалены все коллизии, сочленения и твердое тело
    bool detached = false;

    // Отделяет объект this от родителя и устанавливает флаг, требующий удаления физических свойств
    public void Detach()
    {
        detached = true;
        this.tag = "Untagged";
