...
// Синхронизирует позицию камеры с позицией Y целевого объекта, соблюдая некоторые ограничения.
public class CameraFollow : MonoBehaviour
{
    ...
    // Если камера выбрана в редакторе, рисует линию от верхней граничной точки до нижней.
