...
public class MainMenu : MonoBehaviour
{
    ...
    // Компонент пользовательского интерфейса, содержащий текст "Loading...".
    public RectTransform loadingOverlay;
    // Выполняет загрузку сцены в фоновом режиме. Используется для управления, когда требуется переключить сцену.
    ...
    loadingOverlay.gameObject.SetActive(false);
        ...
        // ...но не переключаться в новую сцену, пока мы не будем готовы.
    ...
    public void LoadScene()
    {
        ...
        // Сообщить операции загрузки сцены, что требуется переключить сцены по окончании загрузки.
